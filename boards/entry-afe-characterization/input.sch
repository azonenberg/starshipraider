...
F 2 "azonenberg_pcb:CONN_SMA_EDGE_SAMTEC_SMA_J_P_H_ST_EM1" H 1100 1550 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_1206_CAP_NOSILK" V 3580 1700 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_1206_CAP_NOSILK" V 4230 1700 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_1206_CAP_NOSILK" V 3980 1550 50  0001 C CNN
...
F 2 "azonenberg_pcb:RELAY_COTO_9202" H 2150 1700 50  0001 C CNN
...
F 2 "azonenberg_pcb:DFN_6_0.65MM_2x2MM_GDS" H 2200 6850 60  0001 C CNN
...
F 2 "azonenberg_pcb:SOD123" H 2550 6200 50  0001 C CNN
...
F 2 "azonenberg_pcb:SOD123" H 2550 6500 50  0001 C CNN
...
F 2 "azonenberg_pcb:BGA_8_2x2_DEPOP1_0.5MM_TI_YZR" H 4450 7050 60  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0402_RES_NOSILK" V 1180 2900 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0402_RES_NOSILK" V 1180 2500 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0402_CAP_NOSILK" H 6238 6050 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0805_CAP_NOSILK" H 6788 6050 50  0001 C CNN
...
F 2 "azonenberg_pcb:SOT323_3" H 5450 1650 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0402_CAP_NOSILK" H 7138 1550 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0402_RES_NOSILK" H 6900 1550 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0603_INDUCTOR_NOSILK" H 7550 1550 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0402_CAP_NOSILK" H 7838 1550 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0603_INDUCTOR_NOSILK" H 8350 1550 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0402_CAP_NOSILK" H 8738 1550 50  0001 C CNN
...
F 2 "azonenberg_pcb:DFN_8_0.5MM_2x1MM" H 2150 4350 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0402_RES_NOSILK" V 4630 4000 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0402_RES_NOSILK" V 4630 4250 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0805_CAP_NOSILK" H 3438 3350 50  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0402_CAP_NOSILK" H 3938 3350 50  0001 C CNN
...
F 2 "azonenberg_pcb:DFN_6_0.65MM_2x2MM_GDS" H 1300 4500 60  0001 C CNN
...
F 2 "azonenberg_pcb:EIA_0402_RES_NOSILK" V 5580 6750 50  0001 C CNN
...
U 1 1 5EABBBE3
P 8900 1150
F 0 "TP3" H 8980 1192 50  0000 L CNN
F 1 "TESTPOINT" H 8980 1101 50  0000 L CNN
F 2 "azonenberg_pcb:TESTPOINT_SMT_0.5MM" H 8900 1150 50  0001 C CNN
...
U 1 1 5EABA2A4
P 5050 1150
F 0 "TP1" H 5130 1192 50  0000 L CNN
F 1 "TESTPOINT" H 5130 1101 50  0000 L CNN
F 2 "azonenberg_pcb:TESTPOINT_SMT_0.5MM" H 5050 1150 50  0001 C CNN
...
U 1 1 5EAC4434
P 8900 2200
F 0 "TP4" H 8980 2242 50  0000 L CNN
F 1 "TESTCLIP" H 8980 2151 50  0000 L CNN
F 2 "azonenberg_pcb:TESTPOINT_SMT_KEYSTONE_5016" H 8900 2200 50  0001 C CNN
...
U 1 1 5EAD15F2
P 5700 5000
F 0 "TP2" H 5780 5042 50  0000 L CNN
F 1 "TESTPOINT" H 5780 4951 50  0000 L CNN
F 2 "azonenberg_pcb:TESTPOINT_SMT_0.5MM" H 5700 5000 50  0001 C CNN
...
U 1 1 5EB7FBFC
P 6200 5500
AR Path="/5EB7FBFC" Ref="C?"  Part="1" 
AR Path="/5E7383DD/5EB7FBFC" Ref="C73"  Part="1" 
F 0 "C73" H 6315 5546 50  0000 L CNN
F 1 "0.47 uF" H 6315 5455 50  0000 L CNN
F 2 "azonenberg_pcb:EIA_0402_CAP_NOSILK" H 6238 5350 50  0001 C CNN
...
U 1 1 5EB8072B
P 6750 5500
AR Path="/5EB8072B" Ref="C?"  Part="1" 
AR Path="/5E7383DD/5EB8072B" Ref="C74"  Part="1" 
F 0 "C74" H 6865 5546 50  0000 L CNN
F 1 "0.47 uF" H 6865 5455 50  0000 L CNN
F 2 "azonenberg_pcb:EIA_0402_CAP_NOSILK" H 6788 5350 50  0001 C CNN
